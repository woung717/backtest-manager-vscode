      ...
      extend: {
        colors: {
          vscode: {
            ...
            "radio-inactiveForeground": "var(--vscode-radio-inactiveForeground)",
            "radio-inactiveBackground": "var(--vscode-radio-inactiveBackground)",
            ...
            "sideBarTitle-border": "var(--vscode-sideBarTitle-border)",
            ...
            "minimap-chatEditHighlight": "var(--vscode-minimap-chatEditHighlight)",
            ...
            "editorMinimap-inlineChatInserted": "var(--vscode-editorMinimap-inlineChatInserted)",
            ...
            "editor-placeholder-foreground": "var(--vscode-editor-placeholder-foreground)",
            ...
            "editor-findMatchForeground": "var(--vscode-editor-findMatchForeground)",
            "editor-findMatchHighlightForeground": "var(--vscode-editor-findMatchHighlightForeground)",
            ...
            "inlineEdit-gutterIndicator-primaryForeground": "var(--vscode-inlineEdit-gutterIndicator-primaryForeground)",
            "inlineEdit-gutterIndicator-primaryBackground": "var(--vscode-inlineEdit-gutterIndicator-primaryBackground)",
            "inlineEdit-gutterIndicator-secondaryForeground": "var(--vscode-inlineEdit-gutterIndicator-secondaryForeground)",
            "inlineEdit-gutterIndicator-secondaryBackground": "var(--vscode-inlineEdit-gutterIndicator-secondaryBackground)",
            "inlineEdit-gutterIndicator-successfulForeground": "var(--vscode-inlineEdit-gutterIndicator-successfulForeground)",
            "inlineEdit-gutterIndicator-successfulBackground": "var(--vscode-inlineEdit-gutterIndicator-successfulBackground)",
            "inlineEdit-gutterIndicator-background": "var(--vscode-inlineEdit-gutterIndicator-background)",
            "inlineEdit-indicator-foreground": "var(--vscode-inlineEdit-indicator-foreground)",
            "inlineEdit-indicator-background": "var(--vscode-inlineEdit-indicator-background)",
            "inlineEdit-indicator-border": "var(--vscode-inlineEdit-indicator-border)",
            ...
            "inlineEdit-originalBorder": "var(--vscode-inlineEdit-originalBorder)",
            "inlineEdit-modifiedBorder": "var(--vscode-inlineEdit-modifiedBorder)",
            "inlineEdit-tabWillAcceptBorder": "var(--vscode-inlineEdit-tabWillAcceptBorder)",
            "inlineEdit-wordReplacementView-background": "var(--vscode-inlineEdit-wordReplacementView-background)",
            ...
            "panelTitle-border": "var(--vscode-panelTitle-border)",
            "panelTitleBadge-background": "var(--vscode-panelTitleBadge-background)",
            "panelTitleBadge-foreground": "var(--vscode-panelTitleBadge-foreground)",
            ...
            "terminalStickyScroll-border": "var(--vscode-terminalStickyScroll-border)",
            ...
            "terminalSymbolIcon-aliasForeground": "var(--vscode-terminalSymbolIcon-aliasForeground)",
            "terminalSymbolIcon-flagForeground": "var(--vscode-terminalSymbolIcon-flagForeground)",
            ...
            "testing-message-error-badgeBackground": "var(--vscode-testing-message-error-badgeBackground)",
            "testing-message-error-badgeBorder": "var(--vscode-testing-message-error-badgeBorder)",
            "testing-message-error-badgeForeground": "var(--vscode-testing-message-error-badgeForeground)",
            ...
            "git-blame-editorDecorationForeground": "var(--vscode-git-blame-editorDecorationForeground)",
            ...
            "gauge-background": "var(--vscode-gauge-background)",
            "gauge-foreground": "var(--vscode-gauge-foreground)",
            "gauge-border": "var(--vscode-gauge-border)",
            "gauge-warningBackground": "var(--vscode-gauge-warningBackground)",
            "gauge-warningForeground": "var(--vscode-gauge-warningForeground)",
            "gauge-errorBackground": "var(--vscode-gauge-errorBackground)",
            "gauge-errorForeground": "var(--vscode-gauge-errorForeground)"
          }
        }
      },
    },
