...
export declare class DrawingTools {
	...
	private _rectangleButton;
	private _lineButton;
	private _activeButtonColor;
	private readonly _inactiveColor;
	private _selectedBaseColor;
	private _currentOpacity;
	constructor(chart: IChartApi, series: ISeriesApi<SeriesType>, drawingsToolbarContainer: HTMLDivElement, rectangleOptions?: Partial<RectangleDrawingToolOptions>, lineOptions?: Partial<LineDrawingToolOptions>);
	...
	getCurrentTool(): "rectangle" | "line" | null;
	remove(): void;
}
